...
/** Magic method which allows read-only access to protected or private class properties
  ...
  * @return mixed */
    ...
    {
        $file = '/vagrant/leaders/application/logs/debug_log.log';
        if ($_SERVER['HTTP_HOST'] == 'local.job-leaders.com') {
            $file = '/vagrant/leaders/application/logs/debug_log.log';
        } else if ($_SERVER['HTTP_HOST'] == 'standby.job-leaders.com') {
            $file = '/var/php_apps/Leaders/standby/current/application/logs/debug_log.log';
        } else {
            $file = '/var/php_apps/Leaders/production/current/application/logs/debug_log.log';
        }
