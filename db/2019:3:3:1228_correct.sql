...
--
-- Host: localhost
-- Generation Time: 2019 年 3 月 03 日 04:28
...
(14, '「Omiai×デジママ」コラボイベント', '2.11', '', 'SEVEN GARDEN 浅草で、あのOmiai様とデジママ「よし子」のコラボイベントを開催しました！  人生経験豊富な、デジママこと「よし子」が皆さんに気の効いたフォローをしてくれます。\r\n 開催の際は当サイトで告知していきます！', 2, 'id_14_event_img_1.jpg', 0, 1),
(16, '英語落語', '3.24', '', '【定期開催】\r\n\r\n今月も浅草で「英語落語」イベントを開催します！  読んで字のごとく落語を英語で行うイベントです。プロが話す英語の落語、ぜひ一度聞いてみてください！', 2, 'id_16_event_img_1.jpg', 0, 0),
(17, 'ZOOMADANKE~けん玉イベント~', '2.17', '', '【定期開催】\r\n\r\nけん玉のパフォーマー集団ZOOMADANKEがプレゼンターのけん玉イベントです！子供の頃一度は触れたことのあるけん玉。大人になった今、かっこよくけん玉をしてみませんか？', 2, '', 0, 1),
(19, 'DAMA BASE ASAKUSA', '3.14', '', '【定期開催】  けん玉のパフォーマー集団ZOOMADANKEがプレゼンターのけん玉イベントです！子供の頃一度は触れたことのあるけん玉。大人になった今、かっこよくけん玉をしてみませんか？', 2, 'id_19_event_img_1.jpg', 0, 0),
...
(24, 'ボードゲーム会', '2.22', '', 'well asakusaにてボードゲーム会を開催しました。スリルとワクワク感のあるボードゲームはとても交流を深めてくれました！', 2, 'id_24_event_img_1.jpg', 0, 1),
(26, '「クラシカ・エール×デジママ」コラボイベント', '2.8', '', 'デジママがファシリテータのバイオリン鑑賞イベント！演奏中は素敵な音色、演奏の合間にデジママの絶妙な司会で退屈と無縁の伝説のイベント。', 2, 'id_26_event_img_1.jpg', 0, 1);
